...
$ for i in 100 110 120 ; do scp /etc/hosts root@192.168.90.$i:/etc/hosts ; done # ㄹ

$ ssh root@192.168.122.100 # ansible.example.com
```
...
$ ansible-playbook -t prepare opens봄tack.yaml
```
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MzM5MjcxMjMsMjAyOTcyOTcwNSwyMj
U4MTE0NDQsMTMwMTY5NDI0MSwtMzk1NTY5NTI0LC0xMjc0MDM1
MjcxLDEyMzkxOTY5NzYsLTUxMjQ0NDM0NywtOTI1NzI1OTE5LD
g2NzgxMzAxMiw3NzM4MTE3OTYsMTMxNzQ5NDA3MSwtMTAzMTQ5
MTM2MywxNzk0NjgwNjcxLDE1MTAxNTU5OTksLTEzOTU3MTA4MT
MsLTMzMjE5NTY3MiwtMTk2ODU2MDk3NSwxMjAyMDMwMDc1LDkw
NzU0ODE3Nl19
-->