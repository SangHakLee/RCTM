...
#### 문제 상황 테스트
VM이 운영중인 상태에서 nova 서비스를 stop해도 VM에 운영에 영향을 주지 않는다.(약한 종속성)

VM이 운영중인 상태에서 libvirtd를 정지해도 VM 운영에 영향을 주지 않는다.

VM이 운영중인 것은 `qemu-kvm`과 연관된 것이다.
과
따라서, 오픈스택으로 구현된 클라우드 컴퓨팅의 장애 발생시 정확히 어디서 발생했는지 파악하지 힘들 수 있다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzgxMTg2MjYxLC0xMjM2NTA5Mjc5LDE3Nj
EyNzEzODIsMjUxNjE4MjE1LC0xODY4MjI4Mzc5LDE0NzA5ODAz
MDAsNTUyNzA2MzEzLC0xNjAzNDAyNDMsLTM4NTE3NjYyNSw0OT
c4MTg4MTAsLTIwODg3NDY2MTIsNzMwOTk4MTE2XX0=
-->