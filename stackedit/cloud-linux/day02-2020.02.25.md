...
$ grep /etc/passwd -e sas -e ssh -e root
```
- `-i`: 대소문자 구분 X
- `-v`: not
- `-e`: 여러개 검색
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxNTk5MjYwMCw5Njg4Njc3NTgsMTE4ND
U4OTk0NiwtMzI4Nzc2MTU4LDMwODk3MTg2OSwtNTg0NzA5NTU5
LDE1Mzg5MzgwODEsLTE5NDI4OTIyNTksNzMwOTk4MTE2XX0=
-->