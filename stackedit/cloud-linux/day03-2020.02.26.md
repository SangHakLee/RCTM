...
$ lvcreate -l 100%FREE -n lvdata vgcloud @slowhdd
...
$ lvcreate --type cache-pool -l 100%FREE -n lvcache vgcloud @ssd
...
$ lvconvert --type cache --cachepool vgcloud/lvcache vgcloud/lvdata
Do you want wipe existing metadata of cache pool volume vgcloud/lvcache? [y/n]: y
  Logical volume vgcloud/lvdata is now cached.
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5NDAxMjE4NywtNjU5Mjk3MDExLDE2Nz
M4NjcyMTAsLTExMDY5ODI4NTksLTcyNjQ1NTM1MiwtNzIzODI0
NTA4LDE2NDk4NTc4MDEsNzU4MzYzMjUwLDExNTAyNzQ2MjIsLT
E0MDY2NTAwMjQsNTQ0MDQ4NTMxLDIwOTIwODgzNzUsLTIwODg3
NDY2MTJdfQ==
-->