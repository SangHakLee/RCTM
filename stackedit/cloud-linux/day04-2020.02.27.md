...
$ yum search xtable # epel에서도 제
```
- `/etc/yum.repos.d/` 디렉토리의 `.repo` 확장자를 갖는 파일이 레포의 설정 파일이다.
- https://fedoraproject.org/wiki/EPEL
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NjUyNDIyNTQsLTE5NTEwNDI2NzIsNz
g5MjI3NjY0LDMxMTQwODU3MCwtMTAyMzg1NTEwNyw5NzUyMjA5
NjUsNDE1MzE1NzI5LC0yNDk5MzQ1MzYsLTIxMTMyMjU5NjMsLT
